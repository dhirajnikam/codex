...
impl PluginsManager {
    ...
    pub async fn install_plugin(
        ...
        self.install_plugin_for_layer_stack(request, /*config_layer_stack*/ None)
            .await
    }
    ...
    pub async fn install_plugin_for_config(
        ...
        self.install_plugin_for_layer_stack(request, Some(&config.config_layer_stack))
            .await
    }

    async fn install_plugin_for_layer_stack(
        &self,
        request: PluginInstallRequest,
        ...
        match self
            .install_resolved_plugin(resolved, config_layer_stack)
            .await
        {
